...
CREATE TABLE `booking` (
	...
	CONSTRAINT fk_booking_depstn FOREIGN KEY (`departure_station_id`) REFERENCES station (`id`),
	CONSTRAINT fk_booking_arrstn FOREIGN KEY (`arrival_station_id`) REFERENCES station (`id`),
